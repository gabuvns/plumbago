  ...
  return (
    <aside className="sidebar">
      ...
      <nav>
        ...
        <button className="nav-item" aria-label={t('sidebar.taxonomies')} title={t('sidebar.taxonomies')} onClick={onTaxonomies}><Tags size={18} /><span>{t('sidebar.taxonomies')}</span></button>
