...
const calendar = require('./services/calendar.cjs'), cloudflare = require('./services/cloudflare.cjs'), deployments = require('./services/deployments.cjs'), history = require('./services/history.cjs'), media = require('./services/media.cjs'), review = require('./services/review.cjs'), trash = require('./services/trash.cjs')
...
module.exports = {
  ...calendar, ...content, ...history, ...media, ...review, ...trash,
