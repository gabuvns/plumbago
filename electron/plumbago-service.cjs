...
const calendar = require('./services/calendar.cjs'), cloudflare = require('./services/cloudflare.cjs'), deployments = require('./services/deployments.cjs'), history = require('./services/history.cjs'), media = require('./services/media.cjs'), pages = require('./services/pages.cjs'), review = require('./services/review.cjs'), trash = require('./services/trash.cjs')
...
const themes = require('./services/themes.cjs'), themeConfigurator = require('./services/theme-configurator/index.cjs')
...
module.exports = {
  ...calendar, ...content, ...history, ...media, ...pages, ...review, ...trash,
  ...
  ...publishing,
  ...site,
  ...themeConfigurator, ...themes, ...taxonomies,
